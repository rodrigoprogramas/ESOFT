...
class ProblemTwoSolutionTest {
    ...
    public void ensureSortingAllNullArraysReturnsNull() {
        // Act
        boolean result = ProblemTwoSolution.sortStudentsByAscendingNumber(null, null, null);
    ...
    public void ensureSortingNullNumbersArrayReturnsFalse() {
        ...
        // Act
        boolean result =
                ProblemTwoSolution.sortStudentsByAscendingNumber(studentNumbers, studentNames, studentGrades);
